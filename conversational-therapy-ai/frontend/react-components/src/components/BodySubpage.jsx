					...
					<div className="card-energy-block">
						...
						<div className="body-copy">
							<div className="today-you-mentioned-low-motivation-and-fogginess-your-body-is-under-resourced-today">
								Today you mentioned low motivation and
								fogginess. Your body is under-resourced today.
							</div>
						</div>
				...
				<div className="your-regulation-moment">
					<div className="card-regulation-moment">
						...
						<div className="exercise-header">
							<div className="_4-6-8-breathing">
								4-6-8 Breathing
							</div>
						...
						<div className="breath-graph">
							<img
								className="timing-guidelines"
								src="timing-guidelines0.svg"
							/>
							<img
								className="waveform-graph"
								src="waveform-graph0.svg"
							/>
							...
							<div className="your-breath-slowed-and-tension-dropped-your-body-remembered-how-to-feel-safe">
								<span>
									<span className="your-breath-slowed-and-tension-dropped-your-body-remembered-how-to-feel-safe-span">
										Your breath slowed and tension dropped.{" "}
										<br />
										Your body remembered how to feel
									</span>
									<span className="your-breath-slowed-and-tension-dropped-your-body-remembered-how-to-feel-safe-span2">
										safe
									</span>
									<span className="your-breath-slowed-and-tension-dropped-your-body-remembered-how-to-feel-safe-span">
										.
				...
				<div className="card-ambient-insight">
					<div className="card-insight">
						...
						<div className="cycle-info">
							<div className="day-18-follicular-phase">
								Day 18, Follicular Phase
							</div>
							<div className="ovulation-in-2-days">
								<span className="ovulation-in-2-days-span">
									Ovulation in{" "}
								</span>
								<span className="ovulation-in-2-days-span2">
									2 days
								</span>
								<span className="ovulation-in-2-days-span">
									.
						...
						<div className="suggestion-block">
							...
							<div className="suggestion-text">
								<div className="this-evening-is-free-and-your-mood-and-desire-is-elevated-this-could-be-a-wonderful-night-for-something-sweet-with-johnny">
									<span>
										<span className="this-evening-is-free-and-your-mood-and-desire-is-elevated-this-could-be-a-wonderful-night-for-something-sweet-with-johnny-span">
											This evening is free and your mood
											and desire is elevated. This could
											be a wonderful night for something
											sweet with{" "}
										</span>
										<span className="this-evening-is-free-and-your-mood-and-desire-is-elevated-this-could-be-a-wonderful-night-for-something-sweet-with-johnny-span2">
											Johnny
										</span>
										<span className="this-evening-is-free-and-your-mood-and-desire-is-elevated-this-could-be-a-wonderful-night-for-something-sweet-with-johnny-span">
											.
				...
				<div className="card-reflect">
					<div className="card-reflect2">
						...
						<div className="insight-label">
							<div className="you-re-in-a-new-place-how-s-your-body-responding-to-the-shift">
								You’re in a new place. How’s your body
