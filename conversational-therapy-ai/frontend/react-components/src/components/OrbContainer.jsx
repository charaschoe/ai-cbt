...
const OrbContainer = ({
  ...
  const gradientStates = {
    default: 'radial-gradient(50% 50% at 50% 50%, rgba(0, 255, 161, 0.8) 0%, rgba(68, 140, 255, 0.6) 50%, rgba(255, 187, 148, 0.4) 100%)',
    calm: 'radial-gradient(50% 50% at 50% 50%, rgba(0, 255, 161, 0.9) 0%, rgba(68, 140, 255, 0.7) 70%, rgba(255, 187, 148, 0.3) 100%)',
    'tuned-in': 'radial-gradient(50% 50% at 50% 50%, rgba(68, 140, 255, 0.9) 0%, rgba(0, 255, 161, 0.7) 40%, rgba(255, 187, 148, 0.5) 100%)',
    emotional: 'radial-gradient(50% 50% at 50% 50%, rgba(255, 187, 148, 0.9) 0%, rgba(68, 140, 255, 0.6) 60%, rgba(0, 255, 161, 0.4) 100%)',
    'deeper-trauma': 'radial-gradient(50% 50% at 50% 50%, rgba(255, 187, 148, 1.0) 0%, rgba(255, 140, 140, 0.8) 50%, rgba(200, 100, 100, 0.6) 100%)'
  };
  ...
  useEffect(() => {
    if (orbRef.current) {
      const gradient = gradientStates[currentVisualState] || gradientStates.default;
      ...
      orbRef.current.style.transition = 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)'; // chat_perfect easing
    }
